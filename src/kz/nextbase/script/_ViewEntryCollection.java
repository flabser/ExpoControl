...
public class _ViewEntryCollection implements _IXMLContent, IProcessInitiator {
	...
	public static final int VIEW_NUMBER_TOTAL_SUM = 0;
	public static final int VIEW_NUMBER_TOTAL_PLUS = 1;
	public static final int VIEW_NUMBER_TOTAL_MINUS = 2;

	private ViewEntryCollection parentObj;
	private LinkedHashSet<_ViewEntry> _entries = new LinkedHashSet<_ViewEntry>();
	private _Session session;
	private static final String viewTextFileds[] = {"viewtext","viewtext1","viewtext2","viewtext3","viewtext4","viewtext5","viewtext6","viewtext7","viewnumber","viewdate"};
	...
	public String toXML(){
		...
		String result = "<query maxpage=\"" + parentObj.getMaxPage() + "\" count=\"" + parentObj.getCount() + "\" currentpage=\"" + parentObj.getCurrentPage() + "\">";
