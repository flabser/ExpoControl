...
public class _Database implements Const {
	...
	_Database(IDatabase db, String userID, _Session session){
	...
	public _ViewEntryCollection getCollectionOfDocuments(String queryCondition, boolean checkResponse){
		...
		return dataBase.getCollectionByCondition(sf, user, 1, 0, session.getExpandedDocuments(), parameters, checkResponse);
	}
	...
	public _ViewEntryCollection getCollectionOfDocuments(String queryCondition, int pageNum, boolean checkResponse){
		...
		RunTimeParameters parameters = new RunTimeParameters();
		return dataBase.getCollectionByCondition(sf, user, pageNum, pageSize, session.getExpandedDocuments(), parameters, checkResponse);
	}

	public _ViewEntryCollection getCollectionOfDocuments(String queryCondition, int pageNum, boolean checkResponse, boolean useFilter){
		FormulaBlocks queryFormulaBlocks = new FormulaBlocks(queryCondition, QueryType.DOCUMENT);
		ISelectFormula sf = new SelectFormula(queryFormulaBlocks);
		int pageSize = user.getSession().pageSize;
		RunTimeParameters parameters = null;
    ...
    public _ViewEntryCollection getCollectionOfDocuments(String queryCondition, int pageNum, boolean checkResponse, boolean useFilter, boolean expandAllResponses){
        FormulaBlocks queryFormulaBlocks = new FormulaBlocks(queryCondition, QueryType.DOCUMENT);
        ISelectFormula sf = new SelectFormula(queryFormulaBlocks);
        int pageSize = user.getSession().pageSize;
        RunTimeParameters parameters = null;
        ...
        return dataBase.getCollectionByCondition(sf, user, pageNum, pageSize, session.getExpandedDocuments(), parameters, checkResponse, expandAllResponses);
    }

    public _ViewEntryCollection getCollectionOfDocuments(String queryCondition, int pageNum, boolean checkResponse, boolean useFilter, String responseQueryCondition){
        FormulaBlocks queryFormulaBlocks = new FormulaBlocks(queryCondition, QueryType.DOCUMENT);
        ISelectFormula sf = new SelectFormula(queryFormulaBlocks);
        int pageSize = user.getSession().pageSize;
        RunTimeParameters parameters = null;
        ...
        return dataBase.getCollectionByCondition(sf, user, pageNum, pageSize, session.getExpandedDocuments(), parameters, checkResponse, responseQueryCondition);
    }

	public _ViewEntryCollection getCollectionOfDocuments(String queryCondition, int pageNum, boolean checkResponse, boolean useFilter, SimpleDateFormat simpleDateFormat){
		FormulaBlocks queryFormulaBlocks = new FormulaBlocks(queryCondition, QueryType.DOCUMENT);
		ISelectFormula sf = new SelectFormula(queryFormulaBlocks);
		int pageSize = user.getSession().pageSize;
		RunTimeParameters parameters = null;
	...
	public _ViewEntryCollection getCollectionOfDocuments(String queryCondition, int pageNum, int pageSize, boolean checkResponse, String sortingColumnName, _Direction direction){
		FormulaBlocks queryFormulaBlocks = new FormulaBlocks(queryCondition, QueryType.DOCUMENT);
		ISelectFormula sf = new SelectFormula(queryFormulaBlocks);
		RunTimeParameters parameters = new RunTimeParameters();
	...
	public _ViewEntryCollection getCollectionOfGlossaries(String queryCondition, int pageNum, int pageSize){
		...
		ISelectFormula sf = new GlossarySelectFormula(queryFormulaBlocks);
		RunTimeParameters parameters = new RunTimeParameters();
		return dataBase.getGlossaries().getCollectionByCondition(sf, pageNum, pageSize, session.getExpandedDocuments(), parameters, true);
	}
	
	public _ViewEntryCollection getCollectionOfGlossaries(String queryCondition, int pageNum, int pageSize, boolean checkResponse, String sortingColumnName, _Direction direction){
		FormulaBlocks queryFormulaBlocks = new FormulaBlocks(queryCondition, QueryType.DOCUMENT);
		ISelectFormula sf = new GlossarySelectFormula(queryFormulaBlocks);
		RunTimeParameters parameters = new RunTimeParameters();
		Sorting s = parameters.new Sorting(sortingColumnName);
		...
		return dataBase.getGlossaries().getCollectionByCondition(sf, pageNum, pageSize, session.getExpandedDocuments(), parameters, checkResponse);
	}
	...
	public _ViewEntryCollection search(String keyWord, int pageNum) throws UnsupportedEncodingException, DocumentException, FTIndexEngineException, RuleException, QueryFormulaParserException{
	...
	public ArrayList<_ViewEntry> getGroupedEntries(String fieldName, int pageNum, int pageSize) throws DocumentException, DocumentAccessException {
		ArrayList<_ViewEntry> col = new ArrayList<_ViewEntry>();

		ArrayList<ViewEntry> entryCollection = dataBase.getGroupedEntries(fieldName, dataBase.calcStartEntry(pageNum, pageSize), pageSize, user);
	...
	public ArrayList<_Document> getDocumentsForMonth(String form, String fieldName, Month month,  int pageNum, int pageSize) throws DocumentException, DocumentAccessException {
		...
		ArrayList<BaseDocument> docsCollection = dataBase.getDocumentsForMonth(userGroups, userID, form, fieldName, m, dataBase.calcStartEntry(pageNum, pageSize), pageSize);
	...
	public _ViewEntryCollection getCollectionOfOrganizations(String queryCondition, int pageNum, int pageSize, String sortingColumnName, _Direction direction){
		//_ViewEntryCollection getOrganization(ISelectFormula sf, int pageNum, int pageSize, RunTimeParameters parameters);
		return null;
	}

	@Deprecated
	public ArrayList<_Document> getAllDocuments(int docType, Set<String> complexUserID, String absoluteUserID, String[] fields, int offset, int pageSize) throws DocumentException, DocumentAccessException, ComplexObjectException {
		ArrayList<BaseDocument> docs = this.dataBase.getAllDocuments(docType, complexUserID, absoluteUserID, fields, offset, pageSize);
	...
	@Deprecated
	public ArrayList<_Document> getAllDocuments(int docType, int offset, int pageSize) throws DocumentException, DocumentAccessException, ComplexObjectException {
		ArrayList<BaseDocument> docs = this.dataBase.getAllDocuments(docType, ((Set<String>)userGroups), userID, offset, pageSize);
		ArrayList<_Document> _docs = new ArrayList<_Document>();
		for (BaseDocument doc : docs) {
	...
	@Deprecated
	public ArrayList<_Document> getDocuments(int docType, int offset, int pageSize) throws DocumentException, DocumentAccessException, ComplexObjectException {
		//	DocumentCollection col =  dataBase.getCollectionByCondition(IQueryFormula condition, Set<String> complexUserID, String absoluteUserID, int offset, int pageSize, Set<DocID> toExpandResponses,String[] filters,String[] sorting);
	...
	@Deprecated
	public _DocumentCollection getAllDocuments(_DocumentType docType, int offset, int pageSize) throws DocumentException, DocumentAccessException, ComplexObjectException {
		switch(docType){
		case MAINDOC:
			ArrayList<BaseDocument> docs = this.dataBase.getAllDocuments(DOCTYPE_MAIN, ((Set<String>)userGroups), userID, offset, pageSize);
			return new _DocumentCollection(docs, session);
		case PROJECT:
			ArrayList<BaseDocument> prjs = this.dataBase.getAllDocuments(DOCTYPE_PROJECT, ((Set<String>)userGroups), userID, offset, pageSize);
			return new _DocumentCollection(prjs, session);
		case TASK:
			ArrayList<BaseDocument> tasks = this.dataBase.getAllDocuments(DOCTYPE_TASK, ((Set<String>)userGroups), userID, offset, pageSize);
			return new _DocumentCollection(tasks, session);
		case EXECUTION:
			ArrayList<BaseDocument> execs = this.dataBase.getAllDocuments(DOCTYPE_EXECUTION, ((Set<String>)userGroups), userID, offset, pageSize);
	...
	@Deprecated
	public ArrayList<_Document> getAllDocuments(int docType, Set<String> complexUserID, String absoluteUserID, int offset, int pageSize) throws DocumentException, DocumentAccessException, ComplexObjectException {
		ArrayList<BaseDocument> docs = this.dataBase.getAllDocuments(docType, complexUserID, absoluteUserID, offset, pageSize);
		ArrayList<_Document> _docs = new ArrayList<_Document>();
		for (BaseDocument doc : docs) {
			_Document _doc = new _Document(doc);
			_docs.add(_doc);
	...
	@Deprecated
	public ArrayList<Integer> getAllDocumentsIDS(int docType, Set<String> complexUserID, String absoluteUserID, String[] fields, int offset, int pageSize) throws DocumentException, DocumentAccessException{
		return this.dataBase.getAllDocumentsIDS(docType, complexUserID, absoluteUserID, fields, offset, pageSize);
	}

	@Deprecated
	public ArrayList<Integer> getAllDocumentsIDS(int docType, Set<String> complexUserID, String absoluteUserID, int offset, int pageSize) throws DocumentException, DocumentAccessException{
		return this.dataBase.getAllDocumentsIDS(docType, complexUserID, absoluteUserID, offset, pageSize);
	}


	@Deprecated
	public ArrayList<Integer> getAllDocumentsIDsByCondition(String query, int docType, Set<String> complexUserID, String absoluteUserID) throws DocumentException, DocumentAccessException{
		return this.dataBase.getAllDocumentsIDsByCondition(query, docType, complexUserID, absoluteUserID);
	}


	@Deprecated
	public ArrayList<_Document> getAllDocsByReader(String query, Set<String> complexUserID, String absoluteUserID) throws DocumentException, QueryFormulaParserException, DocumentAccessException, ComplexObjectException{

		ArrayList <BaseDocument> docs = this.dataBase.getDocumentsByCondition(query, complexUserID, absoluteUserID, 0, 0);
		ArrayList<_Document> _docs = new ArrayList<_Document>();
		for (BaseDocument doc : docs) {
			_Document _doc = new _Document(doc);
			_docs.add(_doc);
	...
	public _DocumentCollection getDocsCollection(String condition, int offset, int limit) throws _Exception{
		try{
			ArrayList<BaseDocument> docs = dataBase.getDocumentsByCondition(condition, userGroups, userID, limit, offset);
			...
			throw new _Exception(_ExceptionType.SCRIPT_ENGINE_ERROR, e.getMessage() + " function: _Document.getDocsCollection(" + condition + ")");
		}
	}


	@Deprecated
	public _DocumentCollection getDocsCollection(String form, int docType, String condition) throws DocumentException, DocumentAccessException, QueryFormulaParserException{
		AppEnv.logger.errorLogEntry("Groovy - _Database.getDocsCollection(String form, String docType, String condition) is obsolete method. Use _Database.getDocsCollection(String condition)(getTasksCollection, getPrjsCollection)");
		return null;
	}
	...
	@Deprecated
	public _DocumentCollection getTasksCollection(String condition) throws DocumentException, DocumentAccessException, QueryFormulaParserException{
	...
	@Deprecated
	public _DocumentCollection getTasksCollection(String condition, Set<String> complexUserID, String absoluteUserID) throws DocumentException, DocumentAccessException, QueryFormulaParserException{
		ArrayList<BaseDocument> docs = new ArrayList<BaseDocument>();
	...
	@Deprecated
	public _DocumentCollection getPrjsCollection(String condition) throws DocumentException, DocumentAccessException, QueryFormulaParserException{
		ArrayList<BaseDocument> docs = dataBase.getProjects().getProjectsByCondition(condition, userGroups, userID);
		return new _DocumentCollection(docs, session);
	}

	@Deprecated
	public _DocumentCollection getPrjsCollection(String condition, HashSet<String> complexUserID, String absoluteUserID) throws DocumentException, DocumentAccessException, QueryFormulaParserException{
		ArrayList<BaseDocument> docs = dataBase.getProjects().getDocumentsByCondition(condition, complexUserID, absoluteUserID);
		return new _DocumentCollection(docs, session);
	}
	...
	@Deprecated
	public String getMainDocumentFieldValueByDOCID(int docID, Set<String> complexUserID, String absoluteUserID, String fieldName) throws DocumentAccessException{
	...
	public _Document getDocumentByComplexID(String docType, String docID) throws _Exception {
		try{
			...
			throw new _Exception(_ExceptionType.SCRIPT_ENGINE_ERROR,"Value has not converted to number: getDocumentByComplexID(" + docType + "," + docID + ")");
		}
	...
	public boolean deleteDocument(String docID, boolean completely) throws _Exception{
		try {
			dataBase.deleteDocument(docID, userGroups, userID, completely);
		}catch(DocumentAccessException e){
			if (e.exceptionType == ExceptionType.DOCUMENT_DELETE_RESTRICTED){
				throw new _Exception(_ExceptionType.DOCUMENT_DELETING_ERROR, "Unable to delete document. Document is read only", this.session);
			}else if(e.exceptionType == ExceptionType.DELETING_RESTRICTED_CAUSED_RELATED_DOCUMENTS){
				throw new _Exception(_ExceptionType.DOCUMENT_DELETING_ERROR, "Unable to delete document. Document has some relations", this.session);
			}
	...
	//You should use delete method with String docID: deleteDocument(String docID, boolean completely)
	@Deprecated
	public boolean deleteDocument(int docType, int docID, boolean completely) throws _Exception{
		try {
			dataBase.deleteDocument(docType, docID, userGroups, userID, completely);
		}catch(DocumentAccessException e){
			//it is to extend to separate error type
			throw new _Exception(_ExceptionType.NO_PERMISSION_TO_READ_THE_DOCUMENT, "Unable to delete document. Security reason: deleteDocument(int docType, int docID, boolean completely)");
		} catch (InstantiationException e) {
			throw new _Exception(e.getMessage());
		} catch (IllegalAccessException e) {
			throw new _Exception(e.getMessage());
    ...
    public boolean unDeleteDocument(String docID) throws _Exception{
        try {
            dataBase.unDeleteDocument(docID, userGroups, userID);
        }catch(DocumentAccessException e){
            //it is to extend to separate error type
            throw new _Exception(_ExceptionType.NO_PERMISSION_TO_READ_THE_DOCUMENT, "Unable to undelete document. Security reason: unDeleteDocument(int docType, int docID, boolean completely)");
        } catch (ComplexObjectException e) {
            throw new _Exception(e.getMessage());
        }
        return true;
	...
	public _Document getTaskByID(int docID, String userName) throws DocumentException, DocumentAccessException{
		AppEnv.logger.errorLogEntry("Groovy - _Database.getTaskByID(int docID, String userName) is obsolete method. Use _Database.getTaskByID(int docID)");
		return null;
	}
	...
	public _Project getProjectByID(int docID, String userName) throws DocumentException, DocumentAccessException{
		AppEnv.logger.errorLogEntry("Groovy - _Database.getProjectByID(int docID, String userName) is obsolete method. Use _Database.getProjectByID(int docID)");
		return null;
	}
	...
	/**@deprecated**/
	public _Glossary getGlossaryDocumentByField(String form, String condition, String returnFieldName) throws DocumentException{
		ScriptProcessor.logger.warningLogEntry("method: _Database.getGlossaryDocumentByField(" + form + "," + condition + "," + returnFieldName + ") deprecated, use _Database.getGlossaryDocument(String form, String condition)");
    ...
    public Document getTopicByPostID(BaseDocument post,  Set<String> complexUserID, String absoluteUserID ) throws DocumentAccessException{
        return this.dataBase.getForum().getTopicByPostID(post, complexUserID, absoluteUserID);
    }

	public _Glossary getGlossaryDocument(String form, String condition) throws DocumentException, QueryFormulaParserException{
	...
	@Deprecated
    public List<_Glossary> getGlossaryDocs(String condition, int pageNum) throws DocumentException, QueryFormulaParserException {
        FormulaBlocks blocks = new FormulaBlocks(condition, QueryType.GLOSSARY);
	...
	@Deprecated
    public List<_Glossary> getGlossaryDocs(String form, String condition) throws DocumentException, QueryFormulaParserException {
        FormulaBlocks blocks = new FormulaBlocks(condition, QueryType.GLOSSARY);
        IQueryFormula queryFormula = dataBase.getQueryFormula("_Database", blocks);
        IGlossaries glos = dataBase.getGlossaries();
