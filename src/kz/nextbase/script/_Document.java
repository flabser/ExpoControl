...
public class _Document {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof _Document)) return false;

        _Document document = (_Document) o;

        if (!doc.equals(document.doc)) return false;
    ...
    public String getValueString(String fieldName) {
        try {
            ...
            ScriptProcessor.logger.errorLogEntry(e.getMessage() + ", function: getValueString(" + fieldName + "), returned:\"\"");
            return "";
        }
    }
    ...
    public Object getValueObject(String fieldName) throws _Exception {
        try {
            ...
            if (e.exceptionType == DocumentExceptionType.FIELD_NOT_FOUND) {
                ScriptProcessor.logger.errorLogEntry(e.getMessage() + ", function: _Document.getValueObject(" + fieldName + "), returned:null");
                return null;
            } else {
                throw new _Exception(_ExceptionType.COMPLEX_OBJECT_ERROR, e.getMessage() + ", function: _Document.getValueObject(" + fieldName + ")");
            }
        } catch (Exception e) {
            throw new _Exception(_ExceptionType.DOCUMENT_FIELD_CAUSED_ERROR, e.getMessage() + ", function: _Document.getValueObject(" + fieldName + ")");
        }
    }
    ...
    public String[] getValue(String fieldName) {
        try {
            ...
            ScriptProcessor.logger.errorLogEntry(e.getMessage() + ", function: _Document.getValue(" + fieldName + "), returned:[\"\"]");
            String[] result = {""};
            return result;
        }
    }
    ...
    public ArrayList<String> getValueList(String fieldName) {
        ...
        try {
            ...
            ScriptProcessor.logger.errorLogEntry("Groovy:" + e.getMessage() + ", function: getValueList(" + fieldName + "), returned:[\"\"]");
        }
        return list;
    }
    ...
    public void setValueNumber(String fieldName, int value) {
        try {
            ...
            ScriptProcessor.logger.errorLogEntry(e.getMessage() + ", function: _Document.getValueNumber(" + fieldName + ")");
        }
    }
    ...
    public String setValueString(String fieldName, String value) {
        try {
            ...
            ScriptProcessor.logger.errorLogEntry(e.getMessage() + ", function: _Document.setValueString(" + fieldName + "," + value + "), returned:\"\"");
            return "";
        }
    }
    ...
    public String getGlossaryValue(String condition, String fieldName) {
        AppEnv.logger.errorLogEntry("_Document.getGlossaryValue(" + condition + "," + fieldName + ") - obsolete method");
        return "";
    }

    public String toXML(String formRuleID, String lang) throws UserException, RuleException, QueryFormulaParserException, DocumentException, DocumentAccessException, QueryException, ComplexObjectException {
    ...
    public String toXML() throws UserException, RuleException, QueryFormulaParserException, DocumentException, DocumentAccessException, QueryException, ComplexObjectException, _Exception {

        return doc.toXML(false);
    }

    public String toXMLWithDescendants(boolean allDescendants) throws UserException, RuleException, QueryFormulaParserException, DocumentException, DocumentAccessException, QueryException, ComplexObjectException {
    ...
    public String getGlossaryValue(String form, String condition, String fieldName) {
        try {
            ...
            ScriptProcessor.logger.errorLogEntry("Groovy:" + e.getMessage() + ", function: _Document.getGlossaryValue(" + form + "," + condition + "," + fieldName + "), returned:\"\"");
            return "";
        }
    }
    ...
    public float getValueFloat(String fieldName) throws _Exception {
        try {
            ...
            if (field != null) {
                ...
                throw new _Exception(_ExceptionType.DOCUMENT_FIELD_NOT_FOUND, "field not found, function: _Document.getValueNumber(" + fieldName + ")");
            }
        } catch (Exception e) {
            throw new _Exception(_ExceptionType.SCRIPT_ENGINE_ERROR, e.getMessage() + " function: _Document.getValueNumber(" + fieldName + ")");
        }
    }
    ...
    public Date getValueDate(String fieldName) throws _Exception {
        try {
            ...
            if (field != null) {
                ...
                throw new _Exception(_ExceptionType.DOCUMENT_FIELD_NOT_FOUND, "field not found, function: _Document.getValueDate(" + fieldName + ")");
            }
        } catch (Exception e) {
            throw new _Exception(_ExceptionType.SCRIPT_ENGINE_ERROR, e.getMessage() + " function: _Document.getValueDate(" + fieldName + ")");
        }
    }
    ...
    public ArrayList<Integer> getValueGlossary(String fieldName) throws _Exception {
        try {
            ...
            if (field != null) {
                ...
                throw new _Exception(_ExceptionType.DOCUMENT_FIELD_NOT_FOUND, "field not found, function: _Document.getValueGlossary(" + fieldName + ")");
            }
        } catch (Exception e) {
            throw new _Exception(_ExceptionType.SCRIPT_ENGINE_ERROR, e.getMessage() + " function: _Document.getValueGlossary(" + fieldName + ")");
    ...
    public void addStringField(String fieldName, String value) throws _Exception {
        if (value.length() > 2046) {
            throw new _Exception(_ExceptionType.FORMDATA_INCORRECT, "Value too long (max=2046)", "_Document.addStringField(" + fieldName + ",value of " + value.length() + ")", session);
        }
    ...
    public void addField(String fieldName, Object value) throws _Exception {
        if (value instanceof _EmployerCollection) {
            ...
            if (o instanceof IComplexObject) {
                doc.addComplexObjectField(fieldName, (IComplexObject) o);
            } else {
            ...
            if (control instanceof IComplexObject) {
                doc.addComplexObjectField(fieldName, (IComplexObject) control);
            } else {
                throw new _Exception(_ExceptionType.FORMDATA_INCORRECT, "Object is not implementation of IComplexObject interface, function: _Document.addStringField(" + fieldName + "," + value + ")");
            }
            ...
            if (execs instanceof IComplexObject) {
                doc.addComplexObjectField(fieldName, (IComplexObject) execs);
            } else {
                throw new _Exception(_ExceptionType.FORMDATA_INCORRECT, "Object is not implementation of IComplexObject interface, function: _Document.addStringField(" + fieldName + "," + value + ")");
            }
    ...
    public void addNumberField(String fieldName, String value) throws _Exception {
        try {
            ...
            throw new _Exception(_ExceptionType.FORMDATA_INCORRECT, "Value has not converted to number format or has been empty, function: _Document.addNumberField(" + fieldName + "," + value + ")");
        }
    }
    ...
    public void addFile(String fieldName, String fileName, String comment) throws _Exception {
        if (session != null) {
            ...
            String tmpFolder = Environment.tmpDir + File.separator + formSesID + File.separator + fieldName + File.separator;
            ...
            throw new _Exception(_ExceptionType.DOCUMENT_FIELD_CAUSED_ERROR, "The attachment cannot be found, function: _Document.addFile(" + fieldName + "," + fileName + "," + comment + ")");
        }
    }
            ...
            for (String fileName : filesToDelete) {
                if (!"".equalsIgnoreCase(fileName)) {
                    ...
                    if (!targetBlob.removeFile(fileName)) {
                        throw new _Exception(_ExceptionType.DOCUMENT_FIELD_CAUSED_ERROR, "Attachment \"" + fileName + "\" has not been deleted from " + this.getDocType() + this.getDocID() + ": _Document.addFile(" + fieldName + "," + webFormData + ")");
                    }
                }
            }
        }
    ...
    public void addFile(String fieldName, HashMap<String, String[]> fields) {
        String filesToDelete[] = (String[]) fields.get("delete" + fieldName + "name");
        ...
        if (filesToDelete != null) {
            ...
            for (String fileName : filesToDelete) {
                ...
                if (!targetBlob.removeFile(fileName)) {
                    System.out.println("Attachment \"" + fileName + "\" has not been deleted from " + this.getDocType() + this.getDocID());
                }
    ...
    public _ViewEntryCollection getAncestry() throws DocumentException, DocumentAccessException {
        FormulaBlocks queryFormulaBlocks = new FormulaBlocks("maindocs.ddbid=\"" + doc.getDdbID() + "\"", QueryType.DOCUMENT);
        ISelectFormula sf = new SelectFormula(queryFormulaBlocks);
        RunTimeParameters parameters = new RunTimeParameters();
        return doc.db.getCollectionByCondition(sf, session.getUser(), 1, 0, session.getExpandedDocuments(), parameters, true);
    }
    ...
    public _Document getGrandParentDocument() throws DocumentException, DocumentAccessException, ComplexObjectException {
        IDatabase db = doc.db;
        BaseDocument grandParentDocument = new RuntimeObjUtil().getGrandParentDocument(db, doc);
        if (grandParentDocument == null) return null;
    ...
    public ArrayList<_Document> getDescendants() throws DocumentAccessException, DocumentException, _Exception {
        try {
            ...
            Set<String> userGroups = new HashSet<String>();
            if (currentUserID != null) {
                if (currentUserID.equalsIgnoreCase("[observer]") || currentUserID.equalsIgnoreCase("server") || currentUserID.equalsIgnoreCase("observer") || currentUserID.equalsIgnoreCase("admin")) {
                    userGroups = Const.sysGroupAsSet;
                } else {
                    Employer user = db.getStructure().getAppUser(currentUserID);
                    if (user != null) userGroups = user.getAllUserGroups();
                }
            }
            ArrayList<BaseDocument> documents = db.getResponses(doc.getDocID(), doc.docType, userGroups, currentUserID);
            for (BaseDocument doc : documents) {
    ...
    private void getResponsesRecursive(ArrayList<_Document> col, BaseDocument doc) throws DocumentAccessException, DocumentException, _Exception {
        try {
            IDatabase db = doc.db;
            Set<String> userGroups = new HashSet<String>();
            if (currentUserID != null) {
    ...
    public boolean save() throws ComplexObjectException {
        try {
            ...
            ScriptProcessor.logger.errorLogEntry("DocumentAccessException " + e.getMessage() + ", function: _Document.save(), returned:false");
            return false;
        } catch (DocumentException e) {
            ScriptProcessor.logger.errorLogEntry("DocumentException " + e.getMessage() + ", function: _Document.save(), returned:false");
            return false;
        } catch (LicenseException e) {
            ScriptProcessor.logger.errorLogEntry("LicenseException " + e.getMessage() + ", function: _Document.save(), returned:false");
            return false;
        }
    }
