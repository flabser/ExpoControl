...
public class SourceSupplier implements IProcessInitiator, Const {
	...
	public ArrayList<BaseDocument> getDocuments(IRuleValue sourceVal, User user) throws DocumentException, DocumentAccessException, RuleException, QueryFormulaParserException, QueryException, ComplexObjectException{
	...
	/**@deprecated**/
	public String[] getValueAsString(ValueSourceType sourceType, String value, Macro macro) throws DocumentException, DocumentAccessException, RuleException, QueryFormulaParserException{
		String returnVal[] = {""};
	...
	public String[] getValueAsStr(ValueSourceType sourceType, String value, Class<GroovyObject> compiledClass, Macro macro) throws DocumentException, DocumentAccessException, RuleException, QueryFormulaParserException, ComplexObjectException{
		String returnVal[] = {""};
	...
	public StringBuffer getDataAsXML(ValueSourceType sourceType, String value, Macro macro, String lang) throws RuleException, DocumentException, DocumentAccessException, QueryFormulaParserException, QueryException, LocalizatorException{
		...
		case VOCABULARY:	
			...
			if (v == null){
				Localizator l = new Localizator(env.globalSetting);
				v = l.populate(value);
				...
				for(String IDAsString : tagValue){
					if (!IDAsString.equals("")){
						...
						try{
							...
							Glossary gloss = env.getDataBase().getGlossaries().getGlossaryDocumentByID(id, true, user.getAllUserGroups(), user.getUserID());					
							if(gloss != null){						
