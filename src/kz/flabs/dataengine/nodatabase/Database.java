...
public class Database implements IDatabase, Const{
    ...
    @Override
	public void fillAccessRelatedField(Connection conn,
			String accessTableSuffix, int docID, Document doc)
					throws SQLException {
	...
	@Override
	public void insertToAccessTables(Connection conn, String accessTableSuffix,
	...
	@Override
	public ArrayList<BaseDocument> getAllDocuments(int docType,	Set<String> complexUserID, String absoluteUserID, int offset, int pageSize) throws DocumentException,DocumentAccessException {
		return null;
	}
	...
	public StringBuffer getDocsByCondition(IQueryFormula condition,
			...
			Set<String> toExpandCategory, TagPublicationFormatType publishAs, int page)
	...
	public ArrayList<BaseDocument> getDocumentsByCondition(
			...
			String absoluteUserID, int limit, int offset) throws DocumentException,
			DocumentAccessException {
		return null;
	}
	...
	public ArrayList<BaseDocument> getDocumentsByCondition(String query,
			Set<String> complexUserID, String absoluteUserID, int limit, int offset)
					throws DocumentException, DocumentAccessException,
					QueryFormulaParserException {
    ...
    @Override
    public BaseDocument getDocumentByComplexID(int docType, int docID, Set<String> complexUserID, String absoluteUserID) throws DocumentAccessException, DocumentException {
        return null;
    }
	...
	public void deleteDocument(int docType, int docID,
			Set<String> complexUserID, String absoluteUserID, boolean completely)
					throws DocumentException, DocumentAccessException {
    ...
    @Override
	public boolean unDeleteDocument(int aid, Set<String> complexUserID,
	...
	@Override
	public XMLResponse unDeleteDocuments(List<DocID> docID,
			Set<String> complexUserID, String absoluteUserID) {
	...
	@Override
	public int insertMainDocument(Document doc, Set<String> complexUserID,
			String absoluteUserID) throws DocumentException {
	...
	@Override
	public int updateMainDocument(Document doc, Set<String> complexUserID,
			String absoluteUserID) throws DocumentAccessException,
			DocumentException {
	...
	@Override
	public BaseDocument getDocumentByDdbID(String ddbID, Set<String> complexUserID, String absoluteUserID)throws DocumentException, DocumentAccessException {	
		return null;
	}
    ...
    @Override
    public _ViewEntryCollection getCollectionByCondition(ISelectFormula sf, User user, int pageNum, int pageSize, Set<DocID> expandedDocuments, RunTimeParameters parameters, boolean checkResponse, String responseQueryCondition) {
        return null;
    }
	...
	@Override
	public void deleteDocument(String id, Set<String> complexUserID,String absoluteUserID, boolean completely)throws DocumentException, DocumentAccessException, SQLException,DatabasePoolException, InstantiationException,
	...
	@Override
	public _ViewEntryCollection getCollectionByCondition(ISelectFormula sf,	User user, int pageNum, int pageSize, Set<DocID> toExpandResponses,	RunTimeParameters parameters, boolean checkResponse) {	
		return null;
	}

	@Override
	public IViewEntry getDocumentByDocID(String docID,	Set<String> complexUserID, String absoluteUserID)	throws DocumentException, DocumentAccessException {
