...
public interface IForum {
	...
	int insertTopic(Topic topic, Set<String> complexUserID, String absoluteUserID);
	int updateTopic(Topic topic, Set<String> complexUserID, String absoluteUserID) throws DocumentAccessException;	
	int deleteTopic(Topic topic, Set<String> complexUserID, String absoluteUserID);
	int insertPost(Post post, Set<String> complexUserID, String absoluteUserID);
	int updatePost(Post post, Set<String> complexUserID, String absoluteUserID) throws DocumentAccessException;	
