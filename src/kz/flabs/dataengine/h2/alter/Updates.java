...
public class Updates {
    //private static String[] readersTables = {"READERS_MAINDOCS","READERS_EXECUTIONS","READERS_TASKS","READERS_PROJECTS"};
    //private static String[] editorsTables = {"AUTHORS_MAINDOCS","AUTHORS_EXECUTIONS","AUTHORS_TASKS","AUTHORS_PROJECTS"};
