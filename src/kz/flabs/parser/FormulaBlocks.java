...
public final class FormulaBlocks implements Const{
	...
	private static final Pattern sysFieldsPattern = Pattern.compile("^\\(?(form|author|docid|viewtext|viewnumber|regdate|lastupdate|ddbid|parentdocid|parentdoctype)");
