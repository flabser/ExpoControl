...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="cssandjs">
		...
		<script type="text/javascript" src="classic/scripts/form.js?ver=2" charset="UTF-8"/>
		<script type="text/javascript" src="classic/scripts/coord.js?ver=2" charset="UTF-8"/>
		<script type="text/javascript" src="classic/scripts/dialogs.js?ver=2" charset="UTF-8"/>
		<script type="text/javascript" src="classic/scripts/outline.js?ver=2" charset="UTF-8"/>
