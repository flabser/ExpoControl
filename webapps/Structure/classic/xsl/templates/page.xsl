			...
			<table style="width:99%; margin-left:3px;" class="time">
				<tr>
					<td>
						...
						<font class="time">
							<xsl:value-of select="//captions/documents/@caption"/>:&#xA0;<xsl:value-of select="//query/@currentpage"/>  &#xA0;<xsl:value-of select="//captions/from/@caption"/>  &#xA0;<xsl:value-of select="//query/@maxpage"/>
						</font>
					</td>
					<td>
