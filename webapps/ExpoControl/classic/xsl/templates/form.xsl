...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="cssandjs">
		<link type="text/css" rel="stylesheet" href="classic/css/main.css?ver=2"/>
		<link type="text/css" rel="stylesheet" href="classic/css/form.css?ver=2"/>
		<link type="text/css" rel="stylesheet" href="classic/css/actionbar.css?ver=2"/>
		<link type="text/css" rel="stylesheet" href="classic/css/dialogs.css?ver=2"/>
		...
		<script type="text/javascript" src="classic/scripts/form.js?ver=2"/>
		<script type="text/javascript" src="classic/scripts/coord.js?ver=2"/>
		<script type="text/javascript" src="classic/scripts/dialogs.js?ver=2"/>
		<script type="text/javascript" src="classic/scripts/outline.js?ver=2"/>
	...
	<xsl:template name="documentheader">
		<div style="position:absolute; top:0px; left:0px; width:100%; background:url(classic/img/header-background.png); height:75px; border-bottom:1px solid #59A3CB; z-index:2">
			...
			<span style="float:right; padding:5px 5px 5px 0px">
				<a id="currentuser" title="{document/captions/view_userprofile/@caption}" href=" Provider?type=edit&amp;element=userprofile&amp;id=userprofile" style="text-decoration:none;color: #444344 ; font: 11px Tahoma; font-weight:bold">
					<font>
						<xsl:value-of select="@username"/>
					</font>
				</a>
				<a id="logout" href="Logout" title="{document/captions/logout/@caption}" style="text-decoration:none; color: #444344 ; font:11px Tahoma; font-weight:bold">
