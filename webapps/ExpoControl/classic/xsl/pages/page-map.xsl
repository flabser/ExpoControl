				...
				<div id="blockWindow" style="display:none"/>
					<div id="wrapper">
						...
						<span id="view" class="viewframe">
							...
							<div id="viewtablediv">
								<div id="tablecontent" style="top:5px">
									<span id="pavinfo" style="position:absolute; width:460px; font-size:14px; min-height:100px; border:2px solid #59a3cb; top:0px; left:540px">
										<table style="border-bottom:1px solid #59a3cb; width:100%">
											<tr>
												<td id="pavinfo_name">Название : </td>
											</tr>
											<tr>
												<td id="pavinfo_count">Количество людей в павильоне : </td>
											</tr>
										</table>
										<table id="userstable" style="width:100%; border-collapse:collapse; margin-top:5px">
											<tr style="border:1px solid  #59a3cb">
												<td style="width:50%; text-align:center">ФИО</td>
												<td style="width:50%; text-align:center">RFID</td>
											</tr>
										</table>										
									</span>
<!-- 									<object data="classic/img/map-2.svg" type="image/svg+xml" id="imap" width="800" height="820"></object> -->
									<object data="classic/img/map-11.svg" type="image/svg+xml" id="imap" width="900" height="800" style="margin-left:-100px; "></object>
<!-- 									<embed src="classic/img/map.svg" id="map" /> -->
