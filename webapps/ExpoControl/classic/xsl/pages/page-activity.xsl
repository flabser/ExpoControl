...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}" style="height:40px; color:#1a3dc1">
			...
			<!-- Дата -->
				<td  style="border:1px solid #ccc;width:155px; padding-left:10px">
					<div style="overflow:hidden; width:99%;">
						<xsl:value-of select="viewcontent/event_time"/>
					</div>
				</td>
			<!-- Объект   -->
			<td  style="border:1px solid #ccc; width:190px;">
				<div style="overflow:hidden; width:100%; padding-left:10px">
					<xsl:value-of select="viewcontent/object"/>
				</div>
			</td>
			<!-- Действие   -->
			<td  style="border:1px solid #ccc; width:190px;">
				<div style="overflow:hidden; width:100%; padding-left:10px">
					<xsl:value-of select="viewcontent/action"/>
				</div>
			</td>
			<!-- ФИО   -->
			...
			<td  style="border:1px solid #ccc;min-width:280px; word-wrap:break-word; padding-left: 10px">
				<div style="display:block; width:99%; " title="{viewcontent/viewtext}">
					<xsl:value-of select="viewcontent/rfid"/>
				</div>
			</td>
		</tr>
									...
									<div id="tableheader">
										<table class="viewtable" id="viewtable" width="100%" style="">
											<tr class="th">
												...
												<xsl:otherwise>
												<td style="width:155px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield" select="'event_time'"/>
												...
												<td style="width:190px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield" select="'object'"/>
												...
												<td style="width:190px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield" select="'action'"/>
												...
												<td style="width:240px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield" select="'fio'"/>
														<xsl:with-param name="sortorder" select="//query/columns/viewtext3/sorting/@order"/>
														<xsl:with-param name="sortmode" select="//query/columns/viewtext3/sorting/@mode"/>
													</xsl:call-template>
						 						</td>
													...
													<td style="min-width:280px;" class="thcell">
														<xsl:call-template name="sortingcellpage">
															<xsl:with-param name="namefield" select="'rfid'"/>
