...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}" style="height:40px; color:#1a3dc1">
			...
			<td  style="border:1px solid #ccc;width:500px; padding-left:10px">
			...
			<td  style="border:1px solid #ccc;min-width:280px; word-wrap:break-word; padding-left: 10px">
				<div style="display:block; width:99%;">
					<xsl:value-of select="viewcontent/count"/> чел.
				</div>
			</td>
		</tr>
								...
								<xsl:value-of select="concat(page/captions/documents/@caption,': ',$query/@count)"/>
									...
									<div id="tableheader">
										<table class="viewtable" id="viewtable" width="100%" style="">
											<tr class="th">
												<td style="width:500px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield" select="'parameters'"/>
