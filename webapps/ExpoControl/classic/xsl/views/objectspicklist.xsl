	...
	<xsl:template match="/request">
		<span width='100%' id='picklistCoorder'>
			<xsl:for-each select="query/entry">
				<div style="display:block; width:100%; text-align:left; height:25px" name="itemStruct">
					...
					<input type="checkbox" name="chbox" id="{@docid}" value="{name}" style="vertical-align:-19px"/>
					<font class="font"  style="font-family:verdana; font-size:13px; margin-left:2px; vertical-align:-17px">
