					...
					<div class="formwrapper">
						<div class="formtitle">
							<div class="title" style="font-size:29px; color:#444344">
								Сотрудник  - <xsl:value-of select="concat(document/fields/surname,' ',document/fields/name,' ', document/fields/patronymic)"/>
							</div>
						</div>
							...
							<div class="ui-tabs-panel" id="tabs-1">
								<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
									<div display="block" id="property">
										...
										<td rowspan="7" style="width:190px; min-width:190px; vertical-align:top">
											...
											<tr>
												...
												<td>
													<input type="text" name="personalid" value="{document/fields/personalid}" size="50" class="td_editable" style="width:600px" autocomplete="off">
											...
											<tr>
												...
												<td>
													<input type="text" name="surname" value="{document/fields/surname}" size="50" class="td_editable" style="width:600px" autocomplete="off">
														<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
											...
											<tr>
												...
												<td>
													<input type="text" name="name" value="{document/fields/name}" size="50" class="td_editable" style="width:600px" autocomplete="off">
														<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
											...
											<tr>
												...
												<td>
													<input type="text" name="patronymic" value="{document/fields/patronymic}" size="50" class="td_editable" style="width:600px" autocomplete="off">
														<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
											...
											<tr>
												...
												<td>
													<input type="text" name="rfid" value="{document/fields/rfid}" size="50" class="td_editable" style="width:600px" autocomplete="off">
														<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
											...
											<tr>
												...
												<td>
													<select name="personal_category" class="select_editable" style="width:500px" autocomplete="off">
														<xsl:for-each select="document/glossaries/personal_category/query/entry">
															<option value="{@docid}">
																<xsl:if test="/request/document/fields/personal_category = @docid">
													...
													<!-- <input type="text" name="category" value="{document/fields/category}" size="50" class="td_editable" style="width:600px">
														<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
											...
											<tr>
												<td class="fc" colspan="2"><xsl:value-of select="document/captions/division/@caption"/> :</td>
												<td>
													<select name="division" class="select_editable" style="width:500px" autocomplete="off">
														<xsl:for-each select="document/glossaries/division/query/entry">
															<option value="{@docid}">
																<xsl:if test="/request/document/fields/division = @docid">
																	<xsl:attribute name="selected">selected</xsl:attribute>
																</xsl:if>
																<xsl:value-of select="viewcontent/viewtext1"/>
															</option>
									...
									<input type="hidden" name="id" value="personal"/>
