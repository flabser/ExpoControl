...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="request">
		...
		<html>
	  		<head>
	 			<title>
	 				<xsl:value-of select="concat('Expo Контроль доступа - ',document/captions/employer/@caption, ': ',document/fields/fullname)"/>
	 			</title>
					...
					<div class="formwrapper">
		            	...
		            	<div class="button_panel">
							<span style="float:left">
		             			<button class="blue-button" title="{document/captions/saveandclose/@caption}" id="btnsavedoc">
							...
							<div display="block"  id="property" width="100%">
								<br/>
	      	    				<table width="80%" border="0" style="margin-top:8px">
				            		...
				            		<tr>
										<td class="fc" style="vertical-align:top"><xsl:value-of select="document/captions/role/@caption"/> :</td>
										<td>
											<table>
				            		...
				            		<tr>
										<td class="fc" style="vertical-align:top"><xsl:value-of select="document/captions/group/@caption"/> :</td>
										<td width="69%">
											<table>
